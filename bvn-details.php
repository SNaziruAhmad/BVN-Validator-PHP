...
curl_setopt($ch, CURLOPT_HTTPHEADER, array('Authorization:Bearer sk_test_43a77dc568bed95f2facd6d788b6a7c713bf018a'));
$out=curl_exec($ch);
curl_close($ch);
//echo $out;
...
<body><header class="w3-content w3-text-white w3-container w3-green">
						<h4> result </h4>
					</header>
	<div class="w3-content w3-card-24 w3-padding w3-margin-top ">
	            <p class="w3-padding w3-large">Message:<?php echo $output_message; ?></p>
	            <p class="w3-padding w3-large">status:<?php echo $output_status; ?></p>
				<p class="w3-padding w3-large">BVN:<?php echo $output_bvn; ?></p>	
				<p class="w3-padding w3-large">First Name:<?php echo $output_first_name; ?></p>
				<p class="w3-padding w3-large">Last Name: <?php echo $output_last_name; ?></p>
				<p class="w3-padding w3-large">Date Of Birth: <?php echo $output_dob; ?></p>
				<p class="w3-padding w3-large">Mobile: <?php echo $output_mobile; ?></p>
				<p class="w3-padding w3-large">Remains <?php echo $output_calls; ?> Checks</p>
		
	</div>
	<div class="w3-content">
		<footer class="w3-green w3-margin w3-margin-top w3-content w3-center">
