...
.w3-opacity,.w3-hover-opacity:hover{opacity:0.60}.w3-text-shadow{text-shadow:1px 1px 0 #444}.w3-text-shadow-white{text-shadow:1px 1px 0 #ddd}
	...
	<title>BVN Validator</title>
</head>
<body><header class="w3-text-white w3-container w3-content w3-green w3-round">
						<h4> check </h4>
					</header>
	<div class="w3-content w3-card-24 w3-padding w3-margin-top">
				<form class="w3-container w3-padding w3-section" action="bvn-details.php" method="post">
					
					<label>BVN</label>
					<input type="text" class="w3-input w3-round w3-border w3-border-blue" placeholder="11 Digits" min="11" maxlength="11" name="bvn" required autofocus />
					<label><b></b></label>
					<div class="w3-container">
						&nbsp;
					</div>
					<input type="submit" name="check" class="w3-btn-block w3-green w3-round w3-padding" value="Check" />
				</form>
		
	<div class="w3-content">
		<footer class="w3-green w3-text-white w3-margin w3-margin-top w3-content w3-center">
